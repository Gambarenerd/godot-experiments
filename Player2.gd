...
func _integrate_forces(state):
	...
	# Get the controls
	var move_left_key = Input.is_action_pressed("player2_ui_left")
	var move_right_key = Input.is_action_pressed("player2_ui_right")
	var jump_key = Input.is_action_just_pressed("player2_ui_select")
